...
class RolloutBuffer(BaseBuffer):
    ...
    def compute_returns_and_advantage(self, last_values: th.Tensor, dones: np.ndarray, use_n_step = None) -> None:
        """
        ...
        for step in reversed(range(self.buffer_size)):
            ...
            if self.use_n_step:
                ...
                advantage = R - self.values[step]
            elif not self.use_n_step:
